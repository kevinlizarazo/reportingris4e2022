...
import { LunarLuminariesPosts } from "./lunarLuminariesPosts";
...
story.add("LunarLuminariesPosts", () => (
  <LunarLuminariesPosts lunarLuminariesPosts={[sample, sample, sample, sample]} />
));
