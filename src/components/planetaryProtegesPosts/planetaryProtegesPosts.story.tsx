...
import { PlanetaryProtegesPosts } from "./planetaryProtegesPosts";
...
story.add("PlanetaryProtegesPosts", () => (
  <PlanetaryProtegesPosts planetaryProtegesPosts={[sample, sample, sample, sample]} />
));
